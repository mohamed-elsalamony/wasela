...
class _MapPageState extends State<MapPage> {
  ...
  getMyCurrentPoint() {
    ...
    if (_currentLocation != null) {
      ...
      currentLatLng = LatLng(31.042401247377263, 31.381649902241946);
    }
  }
...
Marker makeMarker({
  ...
  return Marker(
    ...
    builder: (context) => InkWell(
      child: Image.network(
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-4Obg4Nc062NWgRoJr7_tqMGAyfKJMA7WZZq7D44&s',
        color: color,
      ),
      onTap: () async {
        if (!isMe) {
          await showDialog(
            ...
            builder: ((BuildContext context) {
              return MyAlertDialog(
                ...
                origin: LatLng(31.042401247377263, 31.381649902241946),
