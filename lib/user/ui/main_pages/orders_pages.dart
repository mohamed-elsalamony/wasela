...
import 'package:team_projects/user/ui/subpages/orders_pages/precedent_page.dart';
import 'package:team_projects/user/ui/subpages/orders_pages/required_page.dart';
                  ...
                  child: BlocBuilder<ReservationCubit, ReservationState>(
                    builder: (context, state) {
                      ...
                      return Row(
                        ...
                        children: [
                          DefultBorderButton(
                            isOutline: cubit.currentIndexRequestWorker == 1 ? true : false,
                            title: 'Required',
                            onPressed: () {
                          ...
                          DefultBorderButton(
                            isOutline: cubit.currentIndexEXOrdersWorker == 0 ? true : false,
                            title: 'Precedent',
                            size: 42.w,
                            onPressed: () {
